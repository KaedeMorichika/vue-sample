...
<script>
    ...
    /**
     * この方法では、プログラム全体の辻褄を合わせるのに苦労する。
     * ページに表示されている内容と元データがリンクしていないので、自分で1つずつ合わせていく必要がある。
     *
     * Vue.jsを使った場合は、ページに表示されている内容とデータがリンクしている。
     * 表示に関する処理はVue.js、データの操作に関する処理はPHPと分業させることができる。
     * ⇒保守性アップ！！
     */
</script>
</html>